    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-300">
            <div className="bg-white text-black py-8 px-8 md:px-16 rounded-lg shadow-md">
                <h2 className="text-2xl font-semibold mb-4">Login Here Please</h2>
                ...
                <p className='py-4 text-center'>Don't have an account? <Link to={"/register"} className='text-blue-500'>Register here</Link></p>
